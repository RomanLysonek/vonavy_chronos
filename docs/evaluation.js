...
function renderKpis(data) {
  ...
  const cards = [
    ...
    ["Benchmark folds", data.config?.n_cv_folds ?? "—", "confirmation only"],
  ...
  document.getElementById("development-origins").innerHTML = originPills(inferredOrigins(data, "development"));
  document.getElementById("benchmark-origins").innerHTML = originPills(inferredOrigins(data, "recent_benchmark"));
